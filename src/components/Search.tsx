...
const Search = ({
  ...
  return (
    ...
    via-purple-400 to-lime-400 h-[100vh] w-full">
      <section className="w-full md:max-w-[500px] 
      p-4 flex flex-col text-center items-center 
      justify-center md:px-10 lg:p-24 h-full lg:h-[500px] bg-white
      bg-opacity-20 backdrop-blur-lg
      drop-shadow-lg rounded text-zinc-700">
        <h1 className="text-5xl font-thin">Väder<span className="font-black">Prognos</span></h1>
        <p className="tet-sm mt-3">Skriv in stad du vill veta väderprognos för och välj korrekt från dropdown sökresultatet</p>
            ...
            (
              <li key={option.name + '-' + index}>
                <button 
                  ...
                  cursor-pointer" onClick={() => onOptionSelect(option)}>
